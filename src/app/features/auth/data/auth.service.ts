...
import { BranchUserMyRolesResponse, LoginCredentials, LoginResponse } from '../domain/auth.model';
  ...
  private toSession(
    ...
    const user: User = {
      ...
      branchId:
        ...
        undefined,
      branchNameEn: this.resolveBranchNameEn(response, tokenPayload, branchUserRoles),
      branchNameAr: this.resolveBranchNameAr(response, tokenPayload, branchUserRoles),
      departmentId:
