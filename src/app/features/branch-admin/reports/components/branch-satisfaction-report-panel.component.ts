...
import { BranchAdminTemplate } from '../../branch/models/branch-admin-branch.model';
import { SatisfactionDistributionItem } from '../models/branch-satisfaction-report.model';
...
export class BranchSatisfactionReportPanelComponent implements OnInit, OnDestroy {
  ...
  applyFilters(): void {
    ...
    this.reportStore.load({
      ...
      from: value.from && value.to ? value.from : undefined,
      to: value.from && value.to ? value.to : undefined,
    });
  }
